...
if __name__ == "__main__":
    ...
    run_tsne(before_df, pre, "t-SNE BEFORE augmentation", "reports/nslkdd_tsne/tsne_before.png", args.max_per_class)
    run_tsne(after_df,  pre, "t-SNE AFTER augmentation",  "reports/nslkdd_tsne/tsne_after.png", args.max_per_class)
