...
from compression.kmeans import KMeansCompressor
...
def compress_majority_classes(df, preprocessor, tau=20000):
    ...
    """
    compressor = KMeansCompressor(tau=tau)
    compressed_dfs = []
...
if __name__ == "__main__":
    ...
    compressed_majority = compress_majority_classes(majority_df, preprocessor, tau=20000)
